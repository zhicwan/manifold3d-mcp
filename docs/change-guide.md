...
| Viewer, XR, export or capture                   | [Ownership](../tests/viewer-component-ownership.test.ts), [model export](../tests/model-export.test.ts), [renderer](../tests/renderer.test.ts); flat-build proof when the XR boundary changes                    | Rebuild affected application assets                              |
